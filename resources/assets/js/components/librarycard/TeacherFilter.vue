<template>
  <div>
    ...
    <portal to="LibraryTeacherFilter">
...
<div class="flex flex-col lg:flex-row md:flex-row items-center my-1 w-1/2 px-4">
                  ...
                  <div class="advanced_search_option_container my-1 w-full lg:w-3/5 md:w-2/5">
                    <input class="filter-form-control my-2 lg:my-0 md:my-0" name="issue_date" v-model="issue_date" id="issue_date" type="date" value="" placeholder="Issue Date">       
                  </div>  
                </div> 
                <div class="flex flex-col lg:flex-row md:flex-row items-center my-1 w-1/2 px-4">
                  <div class="person_filter_name_title w-full lg:w-2/5 md:w-2/5">
    ...
    props:['url','searchquery'],
      ...
      methods:
      {
        reset()
        {
          ...
          this.designation='';
          this.marital_status='';
          window.location.href=this.url+"/library/teachers";
        },
        ...
        searchmember()
        {
            ...
            this.final=this.url+'/library/teachers/?'+this.searchquery;
