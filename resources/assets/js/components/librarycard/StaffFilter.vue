            ...
            <div>
              <ul class="search_filter leading-loose">
               <li id="filter-content-name" class="filter_container">
                ...
                <li id="filter-content-librarycard" class="filter_container flex">
                  <div class="flex flex-col lg:flex-row md:flex-row items-center my-1 w-1/2 px-4">
                    <div class="person_filter_name_title w-full lg:w-2/5 md:w-2/5">
                      <p class="text-gray-700">Library Card Number</p>
                    </div>
                    <div class="advanced_search_option_container  my-1 w-full lg:w-3/5 md:w-3/5" >
                      <input class="filter-form-control my-2 lg:my-0 md:my-0" v-model="library_card_no" id="library_card_no" name="library_card_no" type="text" value="" placeholder="Library Card Number">
                    </div>
                  </div>
                  <div class="flex flex-col lg:flex-row md:flex-row items-center my-1 w-1/2 px-4">
                  <div class="person_filter_name_title w-full lg:w-2/5 md:w-2/5">
                    <p class="text-gray-700">Employee ID</p>
                  </div>
                  <div class="advanced_search_option_container my-1 w-full lg:w-3/5 md:w-3/5">
                    <input class="filter-form-control my-2 lg:my-0 md:my-0" name="employee_id" v-model="employee_id" id="employee_id" type="text" value="" placeholder="Employee ID">       
                  </div>  
                </div> 
                </li>
                 <li id="filter-content-librarycard" class="filter_container flex">
                  <div class="flex flex-col lg:flex-row md:flex-row items-center my-1 w-1/2 px-4">
                    <div class="person_filter_name_title w-full lg:w-2/5 md:w-2/5">
                      <p class="text-gray-700">Issue Date</p>
                    </div>
                    <div class="advanced_search_option_container  my-1 w-full lg:w-3/5 md:w-3/5" >
                      <input class="filter-form-control my-2 lg:my-0 md:my-0" v-model="issue_date" id="issue_date" name="issue_date" type="date" value="" placeholder="Issue Date">
                    </div>
                  </div>
                  <div class="flex flex-col lg:flex-row md:flex-row items-center my-1 w-1/2 px-4">
                  <div class="person_filter_name_title w-full lg:w-2/5 md:w-2/5">
                    <p class="text-gray-700">Return Date</p>
                  </div>
                  <div class="advanced_search_option_container my-1 w-full lg:w-3/5 md:w-3/5">
                    <input class="filter-form-control my-2 lg:my-0 md:my-0" name="return_date" v-model="return_date" id="return_date" type="date" value="" placeholder="Return Date">       
                  </div>  
                </div> 
                </li>
   ...
   export default {
    props:['url','searchquery'],
      ...
      methods:
      {
        ...
        //   this.designation='';
        //   this.marital_status='';
          window.location.href=this.url+"/library/staffs";
        },
        ...
        searchmember()
        {
            ...
            this.final=this.url+'/library/staffs/?'+this.searchquery;
        ...
        getData()
          {
            axios.get('/library/teacher').then(response => {
