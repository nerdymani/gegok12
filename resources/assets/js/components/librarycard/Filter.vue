...
<!-- library card  -->
  <!-- <li id="filter-content-age" class="filter_container hide flex"> -->
                                    <div class="flex flex-col lg:flex-row md:flex-row items-center my-1 w-1/2 px-4">
                                        ...
                                        <div class="advanced_search_option_container my-1 w-full lg:w-3/5 md:w-2/5">
                                            <input class="filter-form-control my-2 lg:my-0 md:my-0" name="library_card_no" v-model="library_card_no" id="library_card_no" type="text" placeholder="Library Card Number">       
                                        </div>  
                                    </div> 
                                  ...
                                  <li id="filter-content-age" class="filter_container hide flex">
                                    <div class="flex flex-col lg:flex-row md:flex-row items-center my-1 w-1/2 px-4">
                                        <div class="person_filter_name_title w-full lg:w-2/5 md:w-2/5">
                                            <p class="text-gray-700">Issues Date</p>
                                        </div>
                                        <div class="advanced_search_option_container my-1 w-full lg:w-3/5 md:w-2/5">
                                            <input class="filter-form-control my-2 lg:my-0 md:my-0" name="issue_date" v-model="issue_date" id="issue_date" type="date" placeholder="Issues Date">       
                                        </div>  
                                    </div> 
                                     <div class="flex flex-col lg:flex-row md:flex-row items-center my-1 w-1/2 px-4">
                                        <div class="person_filter_name_title w-full lg:w-2/5 md:w-2/5">
                                        ...
                                        <div class="advanced_search_option_container my-1 w-full lg:w-3/5 md:w-2/5">
                                            <input class="filter-form-control my-2 lg:my-0 md:my-0" name="return_date" v-model="return_date" id="return_date" type="date" placeholder="Retuen  Date">       
                                        </div>  
                                    </div> 
                                       </li>
    ...
    export default {
        ...
        methods:
        {
            reset()
            {
                ...
                {
                    window.location.href=this.url+"/library/students";
                }
            },
            ...
            searchmember()
            {
                ...
                {
                    this.final=this.url+'/library/students?'+this.searchquery;
                }
