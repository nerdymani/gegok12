...
@section('content')
    <div class="w-full">
        <h1 class="admin-h1 my-3 flex items-center">
            <a href="{{ url('/accountant/tasks') }}" title="Back" class="rounded-full bg-gray-100 p-2">
        ...
        <edit-todo url="{{ url('/') }}" id="{{ $task->id }}" searchquery="{{ $query }}" mode="accountant" hidecolumns="true"></edit-todo> 
    </div>
@endsection