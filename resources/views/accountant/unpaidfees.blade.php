...
<div class="">
    <h1 class="admin-h1 my-3 flex items-center">
      	<a href="{{ url('/accountant/dashboard') }}" title="Back" class="rounded-full bg-gray-100 p-2">
    ...
    <unpaid-fee-details url="{{ url('/') }}" fee_id="{{ $fee_id }}" mode="accountant"></unpaid-fee-details>
</div>
@endsection