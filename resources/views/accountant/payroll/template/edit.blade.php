      ...
      <div class="flex flex-wrap lg:flex-row justify-between">
         <div>
            <h1 class="admin-h1 my-3 flex items-center">
               <a href="{{ url('/accountant/payroll/template') }}" title="Back" class="rounded-full bg-gray-100 p-2">
               ...
               <span class="mx-3">Edit Template</span>
            </h1>
         </div>
      </div>

    <edit-template url="{{ url('/') }}" template_id="{{$templateid}}" ></edit-template>
