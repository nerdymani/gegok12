      ...
      <div class="flex flex-wrap lg:flex-row justify-between">
         <div>
            <h1 class="admin-h1 my-3 flex items-center">
               <a href="{{ url('/accountant/payroll/transaction') }}" title="Back" class="rounded-full bg-gray-100 p-2">
               ...
               <span class="mx-3">Edit Transaction</span>
            </h1>
         </div>
      </div>

    <edit-transaction url="{{ url('/') }}" transaction_id="{{$transactionid}}" ></edit-transaction>
