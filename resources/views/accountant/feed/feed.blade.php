  ...
  <form method="GET" action="{{url('/admin/feed/filter')}}" role="search" enctype="multipart/form-data">
	...
	<div>
		...
		<ul class="list-reset leading-loose py-2">
			<li class="py-1"><a href="{{url('/accountant/feeds?search=achievement')}}">Achivements / Kudos</a></li>
			<li class="py-1"><a href="{{url('/accountant/feeds?search=birthday')}}" value="birthday">Birthdays</a></li>
			<li class="py-1"><a href="{{url('/accountant/feeds?search=workanniversary')}}" value="workanniversary">Work Anniversaries</a></li>
			<li class="py-1"><a href="{{url('/accountant/feeds?search=teacher')}}" value="teacher">By Teacher / Staff</a></li>
			<li class="py-1"><a href="{{url('/accountant/feeds?search=student')}}" value="student">By Students</a></li>
		</ul>
	</div>
	<div class="py-3">
		<p class="font-semibold text-red-600">Filter By Source</p>
		<ul class="list-reset leading-loose py-2">
			<li class="py-1"><a href="{{url('/accountant/feeds?list=school')}}" value="school">School</a></li>
			<li class="py-1"><a href="{{url('/accountant/feeds?list=all_class')}}" value="all_class">All Classes</a></li>
			<li class="py-1"><a href="{{url('/accountant/feeds?list=select_class')}}" value="select_class">My Class Only</a></li>
		</ul>
	</div>
	</div>
	  </form>
