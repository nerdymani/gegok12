...
<div class="">
    <h1 class="admin-h1 my-3 flex items-center">
      <a href="{{ url('/admin/notices') }}" title="Back" class="rounded-full bg-gray-100 p-2">
      ...
      <span class="mx-3">Notice Board</span>
    </h1>
    @include('partials.message')
    <create-circular url="{{ url('/') }}" p_date="{{ date('d-m-Y H:i:s') }}" e_date="{{ $e_date }}"></create-circular>  
</div>
