...
@section('content')
	<div class="relative">
     <h1 class="admin-h1 my-3 flex items-center">
      	<a href="{{ url('/receptionist/postalrecord') }}" title="Back" class="rounded-full bg-gray-100 p-2">
      	...
      	<span class="mx-3">Add Postal Record</span>
    </h1>
      @include('partials.message')
      <add-postal-record url="{{ url('/') }}" mode="receptionist" postal_date="{{ $date }}" sender_address="{{$address}}"></add-postal-record>
   </div>
@endsection