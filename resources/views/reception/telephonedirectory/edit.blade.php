...
<div class="">
    <h1 class="admin-h1 my-3 flex items-center">
      	<a href="{{ url('/receptionist/phonenumbers') }}" title="Back" class="rounded-full bg-gray-100 p-2">
      	...
      	<span class="mx-3">Edit Phone Numbers</span>
    </h1>
    @include('partials.message')
    <edit-phone-number  id="{{ $telephonedirectory->id }}" url="{{ url('/') }}" mode="receptionist"></edit-phone-number>
</div>
@endsection