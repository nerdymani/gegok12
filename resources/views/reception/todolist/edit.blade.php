...
@section('content')
    <div class="w-full">
        <h1 class="admin-h1 my-3 flex items-center">
            <a href="{{ url('/receptionist/tasks') }}" title="Back" class="rounded-full bg-gray-100 p-2">
            ...
            <span class="mx-3">Edit To Do</span>
        </h1>
        @include('partials.message')
        <edit-todo url="{{ url('/') }}" id="{{ $task->id }}" searchquery="{{ $query }}" mode="receptionist" hidecolumns="true"></edit-todo> 
    </div>
@endsection