      ...
      <div class="flex flex-col lg:flex-row md:flex-row justify-between">
         ...
         <div class="relative flex items-center w-1/4 lg:justify-end">
            ...
            <div class="flex items-center">
               <a href="{{url('/library/bookscategory/add')}}" class="no-underline text-white px-4 my-3 mx-1 flex items-center custom-green py-1 justify-center whitespace-no-wrap">
