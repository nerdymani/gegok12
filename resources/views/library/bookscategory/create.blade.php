      ...
      <div class="flex flex-wrap lg:flex-row justify-between">
         <div>
            <h1 class="admin-h1 my-3 flex items-center">
               <a href="{{ url('/library/bookscategory/index') }}" title="Back" class="rounded-full bg-gray-100 p-2">
               ...
               <span class="mx-3">Add Books Category</span>
            </h1>
         </div>
      </div>
      @include('partials.message')
     <form method="POST" action="{{url('/library/bookscategory/add')}}" enctype="multipart/form-data">
  @csrf
  ...
  <div class="flex "> 
    <div class="tw-form-group w-full lg:w-1/2 md:w-1/2">
      <div class="lg:mr-8 md:mr-8">
        ...
        <div class="mb-2">
          <input type="text" name="category" id="category" class="tw-form-control w-full" placeholder="Category">
        </div>
