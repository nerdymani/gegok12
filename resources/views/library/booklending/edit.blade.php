...
<div class="">
    <h1 class="admin-h1 my-3 flex items-center">
      <a href="{{ url('/library/books/index') }}" title="Back" class="rounded-full bg-gray-100 p-2">
      ...
      <span class="mx-3">Edit Book Lending</span>
    </h1>
    @include('partials.message')
    <edit-booklending  id="{{ $booklending->id }}" url="{{ url('/') }}"></edit-booklending>  
</div>
