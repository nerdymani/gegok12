...
<div class="">
   ...
   <div class="w-full lg:w-2/4">
   	 ...
   	 <portal-target name="LibraryStaffFilter" ></portal-target>
   </div>
...
<librarystaff-list url="{{url('/')}}"  searchquery="{{$query}}" birthday="{{ $birthday }}" letter="{{ $alphabet }}"></librarystaff-list>

<librarystaff-filter url="{{url('/')}}" searchquery="{{$query}}"></librarystaff-filter>
