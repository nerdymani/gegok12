...
@if($key==2)
<p class="text-gray-800 text-sm font-semibold flex items-center">Upcoming Tasks
                        <span class="bg-teal-400 w-4 h-4 flex items-center justify-center text-xs mx-2 rounded-full text-white inline-block">{{$task->UpcomingTask}}</span>
