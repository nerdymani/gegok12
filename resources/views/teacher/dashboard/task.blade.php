      ...
      <div class="bg-white px-3 py-2 my-3">
        <div class="border-b mx-2 py-1 pb-3 flex flex-col lg:flex-row md:flex-row  lg:items-center md:items-center justify-between">
          <div>
            ...
            <div class="flex items-center">
             <form method="GET" action="{{ url('/teacher/dashboard') }}" role="search" enctype="multipart/form-data">
               <div class="relative">
...
<!-- list tab -->
<list-task-tab url="{{ url('/') }}" mode="teacher"></list-task-tab>
