...
@section('content')
	<div class="">
	    <h1 class="admin-h1 my-3 flex items-center">
	      	<a href="{{ url('/teacher/assignment/show/'.$assignment->id) }}" title="Back" class="rounded-full bg-gray-100 p-2">
                ...
                <table class="w-full">
                    <thead class="bg-grey-light">
                        <tr class="border-b">
                            ...
                            <th class="text-left text-sm px-2 py-2 text-grey-darker"> Read at </th>
                        </tr>
                    </thead>   
                    <tbody >
                    @if(count($viewers)>0)	
