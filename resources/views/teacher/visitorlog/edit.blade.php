...
@section('content')
    <div class="relative">
        <h1 class="admin-h1 my-3 flex items-center">
            <a href="{{ url('/teacher/visitorlog') }}" title="Back" class="rounded-full bg-gray-100 p-2">
            ...
            <span class="mx-3">Edit Visitor Log</span>
        </h1>
        @include('partials.message')
        <edit-visitor-log url="{{ url('/') }}" id="{{ $visitorlog->id }}" mode="teacher"></edit-visitor-log>
    </div>
@endsection