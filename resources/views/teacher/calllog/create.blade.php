...
@section('content')
	<div class="relative">
     <h1 class="admin-h1 my-3 flex items-center">
      	<a href="{{ url('/teacher/calllog') }}" title="Back" class="rounded-full bg-gray-100 p-2">
      	...
      	<span class="mx-3">Add Call Log</span>
    </h1>
      @include('partials.message')
      <add-teacher-call-log url="{{ url('/') }}" mode="teacher"></add-teacher-call-log>
   </div>
@endsection