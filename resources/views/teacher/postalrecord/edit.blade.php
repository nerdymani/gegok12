...
@section('content')
	<div class="relative">
     <h1 class="admin-h1 my-3 flex items-center">
      	<a href="{{ url('/teacher/postalrecord') }}" title="Back" class="rounded-full bg-gray-100 p-2">
      	...
      	<span class="mx-3">Edit Postal Record</span>
    </h1>
      @include('partials.message')
      <edit-teacher-postal-record url="{{ url('/') }}" id="{{ $postalrecord->id }}"  mode="teacher"></edit-teacher-postal-record>
   </div>
@endsection