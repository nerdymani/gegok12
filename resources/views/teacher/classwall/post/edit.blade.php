...
<div class="">
    <h1 class="admin-h1 my-3 flex items-center">
        <a href="{{ url('/classwall/posts') }}" title="Back" class="rounded-full bg-gray-100 p-2">
        ...
        <span class="mx-3">Edit Post</span>
    </h1>
    @include('partials.message')
    <edit-post url="{{ url('/') }}" id="{{ $post->id }}" entity_id="{{ $entity_id }}" entity_name="{{ $entity_name }}" mode="teacher"></edit-post>  
</div>
