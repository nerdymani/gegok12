...
@section('content')
    <div class="relative">
      	<div class="flex flex-wrap lg:flex-row justify-between">
         	...
         	<div class="relative flex items-center w-1/4 justify-end">
            	<div class="flex items-center">
                	<a href="{{ url('/teacher/classwall/post/add') }}" class="no-underline text-white px-4 my-3 mx-1 flex items-center custom-green py-1 justify-center" target="_blank">
        ...
        <post-list url="{{ url('/') }}" entity_id="{{ $entity_id }}" entity_name="{{ $entity_name }}" mode="teacher" auth_id="{{ \Auth::id() }}" hidecolumns="false" id="null"></post-list>
   	</div>
