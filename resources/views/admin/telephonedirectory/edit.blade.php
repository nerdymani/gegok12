...
<div class="">
    <h1 class="admin-h1 my-3 flex items-center">
      	<a href="{{ url('/admin/phonenumbers') }}" title="Back" class="rounded-full bg-gray-100 p-2">
    ...
    <edit-phone-number  id="{{ $telephonedirectory->id }}" url="{{ url('/') }}" mode="admin"></edit-phone-number>
</div>
@endsection