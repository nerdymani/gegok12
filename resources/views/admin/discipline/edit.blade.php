      ...
      <div class="flex flex-wrap lg:flex-row justify-between">
         <div>
            <h1 class="admin-h1 my-3 flex items-center">
               <a href="{{ url('/admin/disciplines') }}" title="Back" class="rounded-full bg-gray-300 p-2">
               ...
               <span class="mx-3">Edit Discipline Details</span>
            </h1>
         </div>
      </div>
      <div class="bg-white shadow px-3 py-2">
      @include('partials.message')
      <edit-discipline url="{{ url('/') }}" id="{{ $discipline->id }}"></edit-discipline>
      </div>
   </div>
@endsection
