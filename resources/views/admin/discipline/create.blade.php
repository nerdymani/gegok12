      ...
      <div class="flex flex-wrap lg:flex-row justify-between">
         <div>
            <h1 class="admin-h1 my-3 flex items-center">
               <a href="{{ url('/admin/disciplines') }}" title="Back" class="rounded-full bg-gray-100 p-2">
               ...
               <span class="mx-3">Add Discipline Details</span>
            </h1>
         </div>
      </div>
      @include('partials.message')
      <create-discipline url="{{ url('/') }}" ref_name="{{ $ref_name }}"></create-discipline>
   </div>
@endsection
