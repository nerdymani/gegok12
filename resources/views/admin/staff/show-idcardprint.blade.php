                    ...
                    <div style="padding: 10px;">
                        <table style="width: 100%;">
                          <tr style="font-size: 13px;padding: 10px 13px;" class="visitor-log">
                              <td style="width: 80%;">
                                 <table style="width: 100%;">
                                        <tr class="visitor-log" style="vertical-align: baseline;">
                                          ...
                                          <td>  <div style="padding-top: 4px;padding-bottom: 4px;"><span style="font-size: 15px;font-weight: 800;">{{$staffs->FullName}}</span></div></td>
                                        </tr>
                                       <!--  <tr class="visitor-log" style="vertical-align: baseline;">
                                         <td colspan="2">
                                            <table style="width: 100%;">
                                        ...
                                        <tr class="visitor-log" style="vertical-align: baseline;">
                                           ...
                                           <td> <div style="padding-top: 4px;padding-bottom: 4px;"><span>{{($staffs->teacherprofile[0]->designation)}},</span></div><!--  {{ $user->userprofile->address }} -->
                                            </td>
                                        </tr>

                                        <tr class="visitor-log" style="vertical-align: baseline;">
                                           <td style="width: 25%;"> <div style="padding-top: 4px;padding-bottom: 4px;color: #4a5568;"><b>DOJ : </b></div></td>
                                           <td> <div style="padding-top: 4px;padding-bottom: 4px;"><span>{{($staffs->userprofile->joining_date)}},</span></div><!--  {{ $user->userprofile->address }} -->
                                            </td>
                                        </tr>

                                        <tr class="visitor-log" style="vertical-align: baseline;">
                                           <td style="width: 25%;"> <div style="padding-top: 4px;padding-bottom: 4px;color: #4a5568;"><b>Address : </b></div></td>
                                           <td> <div style="padding-top: 4px;padding-bottom: 4px;line-height: 1.5;padding-right: 4px;"><span>{{$staffs->userprofile->address}},<br/>
                                            {{$staffs->userprofile->city->name}},<br/>
                                            {{$staffs->userprofile->pincode}}</span></div><!--  {{ $user->userprofile->address }} -->
                                            </td>
                                        </tr>
                              ...
                              <td style="width:20%;">
                                    <p style="padding-bottom: 4px;color: #000;text-align: center;font-size: 13px;"><b>ID : {{($staffs->teacherprofile[0]->employee_id)}}</p>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div style="padding-top: 2px;padding-bottom: 2px;"><span >{{ \Carbon\Carbon::parse($staffs->userprofile->date_of_birth)->format('d-m-Y') }}</span></div>
                                                    </div>
                                                </td>
                                                <td>
                                                    ...
                                                    <div style="padding-top: 2px;padding-bottom: 2px;"><span >{{$staffs->mobile_no}}</span></div>
                                                </div>
                                                </td>
                                                <td>
                                                    <div style="text-align: center;">
