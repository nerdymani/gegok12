...
<div class="w-full lg:mx-2">
    <h1 class="admin-h1 my-3 flex items-center">
        <a href="{{ url('/admin/student/show/'.$user->name) }}" class="rounded-full bg-gray-100 p-2" title="Back">
        ...
        <span class="mx-3">Add Medical History</span>
    </h1>
    @include('partials.message')
    <create-medical-history url="{{ url('/') }}" name="{{ $user->name }}"></create-medical-history>
</div>
