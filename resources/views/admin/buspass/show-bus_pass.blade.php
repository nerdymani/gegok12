...
@section('content')
    <div class="relative">
        <div class="flex flex-wrap lg:flex-row justify-between my-5">
            ...
            <div>
            <a href="{{ url('/admin/student/buspass/showprint/'.$user->name) }}" class="text-xs">
    ...
    <tbody>
      <tr>
        ...
        <td>
         ...
         <tr>
            <!-- <td><p style="font-weight: 700;font-size: 12px;color: #fff;padding-top: 10px;">Year : {{$academic->name}}</p></td> -->
            <td style="text-align: center;"><p style="font-weight: 700;font-size: 18px;color: #fff;">{{$academic->name}}</p></td>
        </tr>
        </table>
           </div>
        </td>
