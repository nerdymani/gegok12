...
@section('content')
    <div class="">
        <h1 class="admin-h1 my-3 flex items-center">
            <a href="{{ url('/admin/homeworks') }}" title="Back" class="rounded-full bg-gray-100 p-2">
            ...
            <span class="mx-3">Home Work</span>
        </h1>
        @include('partials.message')
        <create-homework standard="{{ $standard }}" mode="admin" date="{{ date('Y-m-d') }}"></create-homework>  
    </div>
@endsection