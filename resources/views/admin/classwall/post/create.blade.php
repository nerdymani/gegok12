...
<div class="">
    <h1 class="admin-h1 my-3 flex items-center">
        <a href="{{ url('/admin/classwall/posts') }}" title="Back" class="rounded-full bg-gray-100 p-2">
    ...
    <create-post url="{{ url('/') }}" entity_id="{{ $entity_id }}" entity_name="{{ $entity_name }}" mode="admin"></create-post>  
</div>
