...
@section('content')
	<div class="relative">
     <h1 class="admin-h1 my-3 flex items-center">
      	<a href="{{ url('/admin/postalrecord') }}" title="Back" class="rounded-full bg-gray-100 p-2">
      ...
      <add-postal-record url="{{ url('/') }}" mode="admin" postal_date="{{ $date }}" sender_address="{{$address}}"></add-postal-record>
   </div>
@endsection