...
@section('content')
    <div class="relative">
        <div class="flex flex-wrap lg:flex-row justify-between my-5">
            ...
            <div>
            <a href="{{ url('/admin/teacher/id-card-print/') }}" class="text-xs">
                        ...
                        <div>    
                            ...
                            <div style="padding: 10px;">
                                <div style="display: flex;font-size: 11px;padding: 10px 13px;" class="visitor-log">
                                     ...
                                     <table style="width: 100%;">
                                       ...
                                       <!--  <tr class="visitor-log" style="vertical-align: baseline;">
                                        ...
                                        <tr class="visitor-log" style="vertical-align: baseline;">
                                           ...
                                           <td> <p style="padding-top: 4px;padding-bottom: 4px;padding-right: 4px;word-break: break-all;"><span>{{($user->teacherprofile[0]->designation)}},<br>
                                           
                                            </td>
                                        </tr>
                                         <tr class="visitor-log" style="vertical-align: baseline;">
                                           <td style="width: 25%;"> <p style="padding-top: 4px;padding-bottom: 4px;color: #4a5568;"><b> DOJ  : </b></p></td>
                                           <td> <p style="padding-top: 4px;padding-bottom: 4px;padding-right: 4px;word-break: break-all;"><span>{{($user->userprofile->joining_date)}},<br>
                                        ...
                                        <tr class="visitor-log" style="vertical-align: baseline;">
                                         ...
                                         <tr class="visitor-log" style="vertical-align: baseline;">
                                           <td style="width: 25%;"> <p style="padding-top: 4px;padding-bottom: 4px;color: #4a5568;"><b> Validate Date  : </b></p></td>
                                           <td> <p style="padding-top: 4px;padding-bottom: 4px;padding-right: 4px;word-break: break-all;"><span> {{$academic->name}},<br>
                                  ...
                                  <div style="width:20%;">
                                    <p style="padding-bottom: 4px;color: #000;text-align: center;font-size: 13px;"><b>ID : </b> {{($user->teacherprofile[0]->employee_id)}}</p>
