...
@section('content')
    <div class="relative">
        <div class="flex flex-wrap lg:flex-row justify-between my-5">
            ...
            <div>
            <a href="{{url('/admin/teacher/show-idcardprint/'.$teacher->name)}}" class="text-xs">
...
<td>  <p style="padding-top: 4px;padding-bottom: 4px;"><span style="font-size: 15px;font-weight: 800;">{{ ucfirst($teacher->FullName ?? '') }}</span></p></td>
                                        </tr>
                                       <!--  <tr class="visitor-log" style="vertical-align: baseline;">
                                         <td colspan="2">
                                            <table style="width: 100%;">
                                        ...
                                        <tr class="visitor-log" style="vertical-align: baseline;">
                                           <td style="width: 25%;"> <p style="padding-top: 4px;padding-bottom: 4px;color: #4a5568;"><b>designation : </b></p></td>
                                           <td> <p style="padding-top: 4px;padding-bottom: 4px;padding-right: 4px;word-break: break-all;"><span>{{($teacher->teacherprofile[0]->designation)}},<br>
                                           
                                            </td>
                                        </tr>
                                         <tr class="visitor-log" style="vertical-align: baseline;">
                                           <td style="width: 25%;"> <p style="padding-top: 4px;padding-bottom: 4px;color: #4a5568;"><b>DOJ : </b></p></td>
                                           <td> <p style="padding-top: 4px;padding-bottom: 4px;padding-right: 4px;word-break: break-all;"><span>{{($teacher->userprofile->joining_date)}},<br>
                                        ...
                                        <tr class="visitor-log" style="vertical-align: baseline;">
                                           ...
                                           <td> <p style="padding-top: 4px;padding-bottom: 4px;padding-right: 4px;word-break: break-all;"><span>{{$teacher->userprofile->address}},<br>
                                            {{$teacher->userprofile->city->name}},
                                            {{$teacher->userprofile->pincode}}</span></p><!--  {{ $user->userprofile->address }} -->
                                            </td>
                                        </tr>
                                  ...
                                  <div style="width:20%;">
                                    <p style="padding-bottom: 4px;color: #000;text-align: center;font-size: 13px;"><b>ID : </b> {{($teacher->teacherprofile[0]->employee_id)}}</p>
                                    <span><img src="{{ $teacher->userprofile->AvatarPath }}" style="width: 100px;height: 100px;border-radius: 10px;"></span>
                                </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <p style="padding-top: 2px;padding-bottom: 2px;"><span >{{ $teacher->mobile_no }}</span></p>
                                                </div>
                                                </td>
                                                <td>
                                                    <div style="text-align: center;">
                                                    ...
                                                    @if($teacher->userprofile->blood_group!=null) 
                                                        {{ucwords($teacher->userprofile->blood_group)}} VE
                                                        @else
                                                        -
                                                        @endif
                                                    </span></p>
