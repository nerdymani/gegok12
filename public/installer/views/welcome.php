<div class="bg-white rounded-2xl card-shadow p-8">
    <div class="text-center mb-8">
        ...
        <h2 class="text-3xl font-bold text-gray-800 mb-2">Welcome to Gego K12</h2>
        <p class="text-gray-600 max-w-md mx-auto">
            Thank you for choosing Gego K12 School Management System. This wizard will guide you through the installation process.
        </p>
    </div>
    ...
    <div class="grid md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-gray-50 rounded-xl p-6 text-center">
            ...
            <h3 class="font-semibold text-gray-800 mb-2">Configure App</h3>
            <p class="text-sm text-gray-500">Set up your school information</p>
        </div>
    </div>
